...
export const JobsFilter = ({ onApply }: JobsFilterProps) => {
  ...
  const { keyword: storeKeyword, setStoreKeyword } = useSearchStore(); // zustand에서의 keyword 상태
    ...
    <div className="border rounded-md p-4 mb-8">
      <div className="flex flex-wrap gap-4 mb-4">
              ...
              <div className="flex max-h-60 overflow-y-auto">
                ...
                <div className="w-[50%] border-r p-4 overflow-y-auto">
                  {Object.keys(industryGroups).map((group) => {
                    ...
                    const allSel = children.every((ind) =>
                      selectedJobs.some((j) => j.label === ind)
                    );
                    return (
                      <div key={group} className="mb-2">
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              setSelectedJobs((prev) =>
                                allSel
                                  ? prev.filter(
                                      (j) => !children.includes(j.label)
                                    )
                                  : [
                                      ...prev,
                                      ...items.filter(
                                        (i) =>
                                          !prev.some((j) => j.label === i.label)
                                      ),
                                    ]
                              );
                            }}
                        ...
                        <button
                          ...
                          onClick={() =>
                            setExpandedProvince(
                              expandedProvince === group ? null : group
                            )
                          }
                        >
                          {group} 보기
        ...
        <div className="relative" ref={dropdownRefs.career}>
          <button
            onClick={() =>
              setOpenDropdown(openDropdown === "career" ? null : "career")
            }
            className={`flex items-center justify-between w-32 px-3 py-1.5 border rounded-md bg-white ${
                    ...
                    return (
                      <div key={province.id} className="mb-2">
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (isSelected) {
                                ...
                                setLocations((prev) => [
                                  ...prev,
                                  { id: provinceId, label: province.label },
                                ]);
                              }
                            }}
                          >
                        ...
                        <button
                          ...
                          onClick={() =>
                            setExpandedProvince(
                              isExpanded ? null : province.label
                            )
                          }
                        >
                          {province.label} 보기
