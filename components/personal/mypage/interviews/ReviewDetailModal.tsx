      ...
      <DialogContent className="max-w-xl">
        ...
        <div className="flex flex-col md:flex-row gap-6 my-4">
          ...
          <div className="flex flex-col items-center min-w-[120px]">
            ...
            <div className="text-xs text-gray-500 mt-1">
              {careerLevelMap[review.careerLevel ?? 0]}
            </div>
          </div>
          <div className="flex-1 space-y-3">
            <div>
              <span className="font-medium">면접 연월:</span>{" "}
              {review.interviewYearMonth || "-"}
            </div>
            <div>
              <span className="font-medium">전반적 평가:</span>{" "}
            ...
            <div>
              ...
              {typeof review.difficulty === "number"
                ? difficultyMap[review.difficulty - 1]
                : "-"}
            </div>
            <div>
              <span className="font-medium">면접 유형:</span>{" "}
              {getInterviewTypeLabels(review.interviewType).join(", ") || "-"}
            </div>
            <div>
              <span className="font-medium">면접 인원:</span>{" "}
              {typeof review.interviewParticipants === "number"
                ? participantMap[review.interviewParticipants]
                : "-"}
            </div>
            <div>
              <span className="font-medium">합격 여부:</span>{" "}
