...
export const ResumeContent = () => {
  ...
  useEffect(() => {
    apiClient.get("/api/personal/resume/list")
      .then(res => {
        console.log("[ResumeContent] API에서 받아온 이력서 개수:", res.data.data.length);
        // resumeId -> id 매핑
  ...
  console.log(`[ResumeContent] 현재 페이지(${currentPage})에 보여줄 이력서 개수:`, pagedResumes.length);
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          {filteredResumes.length > 0 ? (
            <>
              <ResumeCardList resumes={pagedResumes} onSetPrimary={handleSetPrimary} onDelete={handleDelete} onPreview={handlePreview} />
