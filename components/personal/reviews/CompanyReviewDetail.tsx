          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-start gap-4">
              <div className="bg-white p-2 rounded-md border w-24 h-24 flex items-center justify-center">
                <Image src={company.logo || "/placeholder.svg"} alt={`${company.name} 로고`} width={80} height={80} />
              </div>
            ...
            <div className="mt-6 flex gap-4 overflow-x-auto pb-2">
              ...
              <button className="flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-md">
                <Image src="/generic-app-icon.png" alt="회사 정보" width={36} height={36} />
                <span className="text-sm">회사에 대해 기재</span>
              </button>

              <button className="flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-md">
                <Image src="/generic-app-icon.png" alt="리뷰 작성" width={36} height={36} />
                <span className="text-sm">리뷰쓰기</span>
              </button>

              <button className="flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-md">
                <Image src="/generic-app-icon.png" alt="채용 정보" width={36} height={36} />
                <span className="text-sm">채용공고 보기</span>
              </button>

              <button className="flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-md">
                <Image src="/generic-app-icon.png" alt="연봉 정보" width={36} height={36} />
                <span className="text-sm">평균 연봉 4000만원</span>
              </button>

              <button className="flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-md">
                <Image src="/generic-app-icon.png" alt="면접 후기" width={36} height={36} />
            ...
            <div className="bg-teal-500 text-white rounded-lg p-6 mb-6">
              <div className="flex items-center gap-4">
                <div className="bg-white/20 rounded-full p-3">
                  <Image src="/diverse-group-chatting.png" alt="메시지 아이콘" width={40} height={40} />
                </div>
                <div>
