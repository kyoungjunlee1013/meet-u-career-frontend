  ...
  return (
    <section className="mb-12">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link href="/personal/jobs/recent" className="text-xs text-gray-500 hover:underline">
          더보기 &gt;
        </Link>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        {recentItems.slice(4, 6).map((item) => (
          <TextCard
            key={item.id}
            title={item.title}
            category={item.category}
